...
const ContactPage = () => {
  ...
  return (
    <section
      id="contact"
      className="relative py-24 bg-gradient-to-br from-navy-900 via-navy-950 to-navy-900"
    >
      {/* Background Elements */}
      ...
      <div className="container mx-auto px-4 max-w-7xl relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <motion.div
            ...
            className="bg-navy-800/50 backdrop-blur-lg rounded-2xl shadow-xl overflow-hidden border border-navy-600/50"
          >
              ...
              {isSubmitted ? (
                ...
                >
                  ...
                  <motion.button
                    ...
                    className="text-accent-400 hover:text-accent-300 font-medium underline transition-colors duration-300"
                  >
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    ...
                    <input
                      ...
                      name="name"
                      required
                      className="w-full px-4 py-3 rounded-lg bg-navy-700/50 border border-navy-600 focus:ring-2 focus:ring-accent-400 focus:border-accent-400 transition-all placeholder-navy-400 text-white"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows="5"
                      required
                      className="w-full px-4 py-3 rounded-lg bg-navy-700/50 border border-navy-600 focus:ring-2 focus:ring-accent-400 focus:border-accent-400 transition-all placeholder-navy-400 text-white resize-none"
                  ...
                  <motion.button
                    ...
                    } text-white font-bold py-4 px-6 rounded-lg transition-all duration-300 shadow-glow hover:shadow-glow-lg flex items-center justify-center`}
                  >
                    {isLoading ? (
                      <>
                        <svg
          ...
          >
            <div className="p-8 sm:p-10 h-full flex flex-col">
              ...
              <div className="space-y-6 mb-8">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <div className="flex items-center">
                      ...
                      <motion.button
                        onClick={copyEmail}
                        className="ml-2 text-accent-400 hover:text-accent-300 transition-colors duration-300 p-1 hover:bg-accent-500/10 rounded"
                        title="Copy email"
                    ...
                    <AnimatePresence>
                      {isCopied && (
                        <motion.span
                          ...
                          animate={{ opacity: 1, y: 0 }}
                          exit={{ opacity: 0, y: -10 }}
                          className="text-xs text-accent-400 mt-1 block"
                        >
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-navy-200">+8801716415528</p>
              ...
              <div className="mt-auto pt-6 border-t border-navy-600/50">
                <h4 className="font-semibold mb-4 text-white">Follow Us</h4>
                <div className="flex space-x-4">
                  <motion.a
                    href="#"
                    className="text-accent-400 hover:text-accent-300 transition-all duration-300 p-3 bg-navy-700/50 rounded-lg hover:bg-navy-600/50"
